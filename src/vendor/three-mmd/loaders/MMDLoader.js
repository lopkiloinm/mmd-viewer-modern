/**
 * Vendored from three.js r164 examples/jsm/loaders/MMDLoader.js for local customization.
 * Diff vs upstream: toon gradient maps use LinearFilter + clamp (see _loadTexture) to avoid
 * hard N·L banding on curved surfaces; edit here instead of patching at runtime.
 */
import {
	AddOperation,
	AnimationClip,
	...
	_loadTexture( filePath, textures, params, onProgress, onError ) {
		...
		const texture = loader.load( fullPath, function ( t ) {
			...
			if ( params.isToonTexture === true ) {
				...
				// Linear ramps soften cel steps for gradientMap (see file header).
